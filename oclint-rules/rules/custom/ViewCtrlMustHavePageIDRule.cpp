...
class ViewCtrlMustHavePageIDRule : public AbstractASTVisitorRule<ViewCtrlMustHavePageIDRule>
{
public:
    virtual const string name() const override
    {
        return "view ctrl must have page i d";
    }
...
static RuleSet rules(new ViewCtrlMustHavePageIDRule());
